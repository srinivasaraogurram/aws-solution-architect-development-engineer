...
- AWS: Lambda, API Gateway, AppSync, DynamoDB, S3, Athena, Glue, Kinesis, Step Functions, EKS, EC2
- IaC: CloudFormation, AWS CDK, Terraform, Serverless Framework, SAM
- CI/CD: Jenkins, GitLab CI/CD, AWS CodeCommit/Build/Pipeline

### Programming

- Java (8,11,17,21), Spring Boot
- Node.js (Express, Serverless runtime)
- Python (Boto3, Glue, Lambda)

### Databases

- RDS (MS SQL Server, Oracle, PostgreSQL, MySQL)
